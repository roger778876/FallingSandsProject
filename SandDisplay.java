						       ...
						       MouseMotionListener, ActionListener, ChangeListener
{
  ...
  public SandDisplay(String title, int numRows, int numCols, String[] buttonNames)
	...
	slider2 = new JSlider(JSlider.HORIZONTAL, 0, 10, 0);
	slider2.addChangeListener(this);
	slider2.setMajorTickSpacing(1);
	slider2.setPaintTicks(true);
	Hashtable<Integer, JLabel> numTable = new Hashtable<Integer, JLabel>();
	numTable.put(new Integer(0), new JLabel("0"));
	numTable.put(new Integer(10), new JLabel("10"));
	slider2.setLabelTable(numTable);
	...
	brushSize = computeBrushSize(slider2.getValue());
    }
    ...
    private int computeBrushSize(int sliderValue){
	return sliderValue;
    }
}
